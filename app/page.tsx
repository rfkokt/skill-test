...
import { ArrowLeft, Camera, FileText, Flag, Moon, Sun, XCircle } from "lucide-react"
      ...
      return (
        <div className="min-h-screen bg-neobrutal-bg text-neobrutal-text">
          ...
          <div className="max-w-7xl mx-auto p-6 flex flex-col gap-6">
            ...
            <div className="bg-neobrutal-card rounded-lg p-6 border-2 border-neobrutal-border shadow-[4px_4px_0px_0px_#333333]">
              <h2 className="text-lg font-semibold text-neobrutal-text mb-4">Your Answer</h2>
              <div className="mb-6">
                <textarea
        ...
        <div className="max-w-7xl mx-auto p-6 flex flex-col gap-6">
              ...
              {currentProblem.languages.map((lang) => (
                <TabsContent key={lang} value={lang} className="space-y-4">
                  <ResizablePanelGroup direction="horizontal" className="min-h-[400px]">
                    <ResizablePanel
                      defaultSize={
                        currentProblem.id.startsWith("react-") && selectedEditorLanguage === "javascript" ? 65 : 100
                      }
                    >
                      {/* Code Editor */}
          ...
          {showResults && (
            <div className="bg-neobrutal-card rounded-lg p-6 border-2 border-neobrutal-border shadow-[4px_4px_0px_0px_#333333] mt-6">
              <h2 className="text-lg font-semibold text-neobrutal-text mb-4">Test Results</h2>
              <div className="mb-4">
                ...
                {testResults.map((result, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-semibold text-neobrutal-text">Test Case {result.testCase}</h3>
                      <Badge
                        className={
                          result.passed
                            ? "bg-neobrutal-softGreen text-neobrutal-softGreenText"
